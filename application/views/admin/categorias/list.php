    ...
    <section class="content">
        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        <?php if(isset($permisos) && $permisos->insert == 1):?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <button type="button" class="btn btn-warning btn-view" data-toggle="modal" data-target="#modal-default" value="<?php echo $categoria->id;?>">
                                                        <span class="fa fa-pencil"></span>
                                                    </button>
                                                    <button type="button" class="btn btn-danger btn-view" data-toggle="modal" data-target="#modal-default" value="<?php echo $categoria->id;?>">
                                                        <span class="fa fa-trash"></span>
                                                    </button>
                                                    <?php if(isset($permisos) && $permisos->update == 1):?>
                                                    ...
                                                    <?php endif;?>
                                                    <a href="<?php echo base_url()?>mantenimiento/categorias/edit/<?php echo $categoria->id;?>" class="btn btn-warning"><span class="fa fa-pencil"></span></a>
                                                    <?php if(isset($permisos) && $permisos->delete == 1):?>
